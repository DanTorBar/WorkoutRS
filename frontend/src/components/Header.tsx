    ...
    <header className="bg-white text-white border-b-2 border-border">
      ...
      >
        ...
        <PopoverGroup className="hidden lg:flex lg:gap-x-12">
          <Link href="/rutinas" className="text-sm/6 font-semibold text-gray-900">
            Rutinas
          </Link>
          <Link href="/ejercicios" className="text-sm/6 font-semibold text-gray-900">
            Ejercicios
          </Link>
          <Link href="/recomendaciones" className="text-sm/6 font-semibold text-gray-900">
            Recomendaciones
          </Link>
        </PopoverGroup>
